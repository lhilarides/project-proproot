import{aa as S,ab as x}from"./GeoJSON-DjleBiMy.js";import{D as E,W as I,a as f,b as m,S as O,e as v,U as s,A as d,n as C,g,u as N}from"./compileUtil-COkr_AiM.js";import A from"./BaseTile-DbeLNUSH.js";import"./index-DHnkhHSW.js";import"./_commonjsHelpers-CE1G-McA.js";import"./utils-BQP3ipBT.js";import"./I18N-BC6F-L_M.js";import"./BFormRadioGroup.vue_vue_type_script_setup_true_lang-DaMHx4U3-BW6zhZPI.js";import"./useStateClass-BGbSLWFN-CyjORyAE.js";import"./ConditionalWrapper.vue_vue_type_script_lang-IX_NpHH--Bx6i8GtS.js";import"./mat4-CeypvY8Z.js";import"./DataTile-CRN3yvLw.js";import"./Tile-B5E403_X.js";import"./Tile-SdHSduHF.js";import"./common-D0Hwmgqw.js";import"./TileRange-2Tc-Ry00.js";import"./LRUCache-BG-UknQv.js";import"./tilecoord-CsqQRJzc.js";import"./TileProperty-BF4LcWSy.js";const e={TEXTURE:"u_texture",VELOCITY_TEXTURE:"u_velocityTexture",POSITION_TEXTURE:"u_positionTexture",PARTICLE_COUNT_SQRT:"u_particleCountSqrt",MAX_SPEED:"u_maxSpeed",RANDOM_SEED:"u_randomSeed",SPEED_FACTOR:"u_speedFactor",DROP_RATE:"u_dropRate",DROP_RATE_BUMP:"u_dropRateBump",OPACITY:"u_opacity",ROTATION:E.ROTATION,VIEWPORT_SIZE_PX:E.VIEWPORT_SIZE_PX},T={POSITION:"a_position",INDEX:"a_index"},c={POSITION:"v_position"};class $ extends I{constructor(r,t){super(r,{vertexShader:t.tileVertexShader,fragmentShader:t.tileFragmentShader,cacheSize:t.cacheSize,postProcesses:[{}],uniforms:{[e.MAX_SPEED]:t.maxSpeed}}),this.particleColorFragmentShader_=t.particleColorFragmentShader,this.velocityTexture_=null,this.particleCountSqrt_=t.particles?Math.ceil(Math.sqrt(t.particles)):256,this.particleIndexBuffer_,this.quadBuffer_,this.particlePositionProgram_,this.particlePositionVertexShader_=t.particlePositionVertexShader,this.particlePositionFragmentShader_=t.particlePositionFragmentShader,this.previousPositionTexture_,this.nextPositionTexture_,this.particleColorProgram_,this.particleColorVertexShader_=t.particleColorVertexShader,this.particleColorFragmentShader_=t.particleColorFragmentShader,this.textureProgram_,this.textureVertexShader_=t.textureVertexShader,this.textureFragmentShader_=t.textureFragmentShader,this.previousTrailsTexture_,this.nextTrailsTexture_,this.fadeOpacity_=.996,this.maxSpeed_=t.maxSpeed,this.speedFactor_=t.speedFactor||.001,this.dropRate_=.003,this.dropRateBump_=.01,this.tempVec2_=[0,0],this.renderedWidth_=0,this.renderedHeight_=0}afterHelperCreated(){super.afterHelperCreated();const r=this.helper,t=r.getGL();this.framebuffer_=t.createFramebuffer();const i=this.particleCountSqrt_*this.particleCountSqrt_,o=new Float32Array(i);for(let _=0;_<i;++_)o[_]=_;const a=new f(m,O);a.setArray(o),r.flushBufferData(a),this.particleIndexBuffer_=a;const l=new Float32Array([0,0,1,0,0,1,0,1,1,0,1,1]),h=new f(m,O);h.setArray(l),r.flushBufferData(h),this.quadBuffer_=h;const n=new Uint8Array(i*4);for(let _=0;_<n.length;++_)n[_]=Math.floor(Math.random()*256);this.previousPositionTexture_=r.createTexture([this.particleCountSqrt_,this.particleCountSqrt_],n,null,!0),this.nextPositionTexture_=r.createTexture([this.particleCountSqrt_,this.particleCountSqrt_],n,null,!0),this.particlePositionProgram_=r.getProgram(this.particlePositionFragmentShader_,this.particlePositionVertexShader_),this.particleColorProgram_=r.getProgram(this.particleColorFragmentShader_,this.particleColorVertexShader_),this.textureProgram_=r.getProgram(this.textureFragmentShader_,this.textureVertexShader_)}createSizeDependentTextures_(){const r=this.helper,t=r.getGL(),i=r.getCanvas(),o=i.width,a=i.height,l=new Uint8Array(o*a*4);this.nextTrailsTexture_&&t.deleteTexture(this.nextTrailsTexture_),this.nextTrailsTexture_=r.createTexture([o,a],l,null,!0),this.previousTrailsTexture_&&t.deleteTexture(this.previousTrailsTexture_),this.previousTrailsTexture_=r.createTexture([o,a],l,null,!0)}beforeFinalize(r){const t=this.helper,i=t.getGL(),o=t.getCanvas(),a=o.width,l=o.height;(this.renderedWidth_!=a||this.renderedHeight_!=l)&&this.createSizeDependentTextures_();const h=[a,l];this.velocityTexture_=t.createTexture(h,null,this.velocityTexture_),i.copyTexImage2D(i.TEXTURE_2D,0,i.RGBA,0,0,a,l,0),this.drawParticleTrails_(r),this.updateParticlePositions_(r),r.animate=!0,this.renderedWidth_=a,this.renderedHeight_=l}drawParticleTrails_(r){const t=this.helper,i=t.getGL();t.bindFrameBuffer(this.framebuffer_,this.nextTrailsTexture_),this.drawTexture_(this.previousTrailsTexture_,this.fadeOpacity_),this.drawParticleColor_(r),t.bindInitialFrameBuffer(),i.clearColor(0,0,0,0),i.clear(i.COLOR_BUFFER_BIT),i.enable(i.BLEND),i.blendFunc(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA),this.drawTexture_(this.nextTrailsTexture_,1),i.disable(i.BLEND);const o=this.nextTrailsTexture_;this.nextTrailsTexture_=this.previousTrailsTexture_,this.previousTrailsTexture_=o}drawTexture_(r,t){const i=this.helper,o=i.getGL();i.useProgram(this.textureProgram_),i.bindTexture(r,0,e.TEXTURE),i.bindAttribute(this.quadBuffer_,T.POSITION,2),this.helper.setUniformFloatValue(e.OPACITY,t),o.drawArrays(o.TRIANGLES,0,6)}drawParticleColor_(r){const t=this.helper,i=t.getGL();t.useProgram(this.particleColorProgram_);const o=this.particleCountSqrt_*this.particleCountSqrt_;t.bindAttribute(this.particleIndexBuffer_,T.INDEX,1),t.bindTexture(this.previousPositionTexture_,0,e.POSITION_TEXTURE),t.bindTexture(this.velocityTexture_,1,e.VELOCITY_TEXTURE),this.helper.setUniformFloatValue(e.PARTICLE_COUNT_SQRT,this.particleCountSqrt_);const a=this.tempVec2_;a[0]=Math.cos(-r.viewState.rotation),a[1]=Math.sin(-r.viewState.rotation),this.helper.setUniformFloatVec2(e.ROTATION,a),this.helper.setUniformFloatValue(e.MAX_SPEED,this.maxSpeed_),i.drawArrays(i.POINTS,0,o)}updateParticlePositions_(r){const t=this.helper,i=t.getGL();t.useProgram(this.particlePositionProgram_),i.viewport(0,0,this.particleCountSqrt_,this.particleCountSqrt_),t.bindFrameBuffer(this.framebuffer_,this.nextPositionTexture_),t.bindTexture(this.previousPositionTexture_,0,e.POSITION_TEXTURE),t.bindTexture(this.velocityTexture_,1,e.VELOCITY_TEXTURE),t.bindAttribute(this.quadBuffer_,T.POSITION,2),t.setUniformFloatValue(e.RANDOM_SEED,Math.random()),t.setUniformFloatValue(e.SPEED_FACTOR,this.speedFactor_),t.setUniformFloatValue(e.DROP_RATE,this.dropRate_),t.setUniformFloatValue(e.DROP_RATE_BUMP,this.dropRateBump_);const o=this.tempVec2_;o[0]=Math.cos(-r.viewState.rotation),o[1]=Math.sin(-r.viewState.rotation),this.helper.setUniformFloatVec2(e.ROTATION,o);const a=r.size;this.helper.setUniformFloatVec2(e.VIEWPORT_SIZE_PX,[a[0],a[1]]),i.drawArrays(i.TRIANGLES,0,6);const l=this.nextPositionTexture_;this.nextPositionTexture_=this.previousPositionTexture_,this.previousPositionTexture_=l}}const y=`
  ...
  void main() {
    ...
    gl_Position = ${s.TILE_TRANSFORM} * vec4(${d.TEXTURE_COORD}, ${s.DEPTH}, 1.0);
  }
`,D=`
...
`)}
  ...
  `;return{tileVertexShader:y,tileFragmentShader:D,particleColorVertexShader:X,particleColorFragmentShader:h,particlePositionVertexShader:P,particlePositionFragmentShader:U,textureVertexShader:P,textureFragmentShader:F}}const R=[];class L extends A{constructor(r){const t=Object.assign({},r);if(delete t.maxSpeed,delete t.speedFactor,delete t.particles,super(t),this.style_=r.style||{},!(r.maxSpeed>0))throw new Error("maxSpeed is required");this.maxSpeed_=r.maxSpeed,this.speedFactor_=r.speedFactor,this.particles_=r.particles,this.styleVariables_=this.style_.variables||{},this.addChangeListener(S.SOURCE,this.handleSourceUpdate_)}handleSourceUpdate_(){this.hasRenderer()&&this.getRenderer().clearCache()}updateStyleVariables(r){Object.assign(this.styleVariables_,r),this.changed()}getSources(r,t){const i=this.getSource();return R[0]=i,R}createRenderer(){const r=b(this.style_);return new $(this,{...r,cacheSize:this.getCacheSize(),maxSpeed:this.maxSpeed_,speedFactor:this.speedFactor_,particles:this.particles_})}}L.prototype.dispose;export{L as default};
//# sourceMappingURL=Flow-COe0pyNj.js.map
